    ...
    <div className="relative flex h-screen bg-[#FDFDFD] text-slate-800 font-sans overflow-hidden selection:bg-pink-200 selection:text-pink-900">
      ...
      <main className="relative z-20 flex-1 flex flex-col overflow-hidden">
        <header className="h-20 flex items-center justify-between px-10 bg-white/50 backdrop-blur-2xl border-b border-white/60 flex-shrink-0 z-10 shadow-[0_4px_30px_rgba(0,0,0,0.02)]">
          <div className="flex items-center space-x-4">
            <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">Panel Verifikasi</h2>
            <div className="h-5 w-[2px] bg-slate-200 rounded-full hidden md:block"></div>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest bg-white/60 px-3 py-1 rounded-full border border-white hidden md:block">Pusat Persetujuan</span>
          </div>
      ...
      {isProfileModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white/90 backdrop-blur-2xl border border-white rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.1)] overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="p-8 space-y-4">
               <div className="bg-slate-50/50 p-4 rounded-xl border border-slate-200 shadow-inner">
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50/50 flex justify-between items-center rounded-b-[2rem]">
              <button onClick={handleLogout} className="flex items-center space-x-2 text-red-500 hover:bg-red-50 px-4 py-2.5 rounded-xl transition-all text-sm font-bold border border-transparent hover:border-red-200">
